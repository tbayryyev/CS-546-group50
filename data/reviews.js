...
const exported = {
  ...
  addLikeComment: async (commentID, reviewID, userID) => {
    ...
    const updateInfo = await reviewCollection.updateOne({ reviewID: ObjectId(reviewID), commentID: ObjectId(commentID) }, { $addToSet: { comments: { likes: ObjectId(userID) } } });
  ...
  addDislikeComment: async (commentID, reviewID, userID) => {
    ...
    const updateInfo = await reviewCollection.updateOne({ reviewID: ObjectId(reviewID), commentID: ObjectId(commentID) }, { $addToSet: { comments: { dislikes: ObjectId(userID) } } });
